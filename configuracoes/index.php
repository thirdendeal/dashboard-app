...
<?php
include_with("default", ["title" => "Configurações", "tab" => 4]);
?>
  ...
  <div class="container">
    ...
    <ul class="command-list">
      <li class="command-item">
        <form action="/_/controller/configuracoes/connect.php" method="post">
      ...
      <li class="command-item">
        <form action="/_/controller/configuracoes/database.php" method="post">
      ...
      <li class="command-item">
        <form action="/_/controller/configuracoes/setup.php" method="post">
      ...
      <li class="command-item">
        <form action="/_/controller/configuracoes/populate.php" method="post">
      ...
      <li class="command-item">
        <form action="/_/controller/configuracoes/drop.php" method="post">
