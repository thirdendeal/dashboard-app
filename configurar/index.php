        ...
        <ul>
          ...
          <li>
            <form action="/_controller/configurar/setup.php" method="post">
              <input class="button button--green full-width left" type="submit" value="Setup">
            </form>
          ...
          <li>
            <form action="/_controller/configurar/drop.php" method="post">
              <input class="button button--green full-width left" type="submit" value="Remover Banco de Dados">
            </form>
          ...
          <li>
            <form action="/_controller/configurar/populate.php" method="post">
              <input class="button button--green full-width left" type="submit" value="Inserir Mockup">
            </form>
