...
$row = select_from_where("*", "dashboard_app.fornecedor", ["id_fornecedor = ?", [$id]]); // one or none
...
<?php
include_with("default", ["title" => $fornecedor["nome"], "tab" => 2]);
?>
    ...
    <?php if ($fornecedor) { ?>
      ...
      <ul class="list">
        <li class="list__item">
          ...
          <form style="display: none" class="list__form" action="/_controller/fornecedor/edit.php" method="post">
            ...
            <div class="list__form__padlock">
              <input class="list__submit button button--green" type="submit" value="Atualizar" />
              <button class="list__cancel button button--red" type="button">Cancelar</button>
            </div>
          </form>
        ...
        <li class="list__item">
          ...
          <p class="list__p <?= $fornecedor['status'] ? 'green' : 'red' ?>">
